...
public class BMW_520d extends E_BMW {
    public BMW_520d(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
