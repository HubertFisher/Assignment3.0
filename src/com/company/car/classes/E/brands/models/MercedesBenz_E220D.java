...
public class MercedesBenz_E220D extends E_MercedesBenz {
    public MercedesBenz_E220D(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
