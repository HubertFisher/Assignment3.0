...
public class E_MercedesBenz extends E_Class {
    ...
    public E_MercedesBenz(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
