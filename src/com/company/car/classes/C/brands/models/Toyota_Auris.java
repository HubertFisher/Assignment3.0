...
public class Toyota_Auris extends C_Toyota {
    public Toyota_Auris(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
