...
public class Toyota_Camry extends C_Toyota {
    public Toyota_Camry(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
