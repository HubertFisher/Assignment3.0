...
public class Volkswagen_Polo extends C_Volkswagen {
    public Volkswagen_Polo(String brand, String model, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction, int price, int numberOfSeats) {
