package com.company.car.segment.comfort;

import com.company.car.Car;
import com.company.details.engine.Engine;
import com.company.details.transmission.Transmission;

public class ComfortSUV extends Car {
    private final String suspension = "Medium";
    ...
    public ComfortSUV(String name, Engine engine, Transmission transmission, double VIN, String color, int yearOfProduction) {
